...
RAW_MBOX_DIR = (PROJECT_ROOT / "rag/data/raw/mbox").resolve()
OUTPUT_JSONL = (PROJECT_ROOT / "rag/data/clean/email_chunks.jsonl").resolve()
PROCESSED_MBOX_TXT = (PROJECT_ROOT / "rag/data/clean/processed_mboxes.txt").resolve()
