...
BUDGET_USDC = 250.0  # 每侧订单按 250 USDC 名义金额下单，用它反推买卖数量
GRID_STEP = 200.0  # 参考价每上下偏移 200 美元挂一格，是网格的基础间距
BUY_GRID_FACTOR = 0.9  # 买单距离 = 0.90 x GRID_STEP
SELL_GRID_FACTOR = 1.1  # 卖单距离 = 1.10 x GRID_STEP
