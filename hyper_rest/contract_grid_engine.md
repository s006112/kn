...
本文档只描述以 `hyperliquid/grid.py`、`hyperliquid/grid_infra.py`、`hyperliquid/grid_execution.py`、`hyperliquid/grid_decision.py` 与 `hyperliquid/grid_logic.py` 为边界的 grid engine migration baseline contract。
